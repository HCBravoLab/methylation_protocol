...
knitr::opts_chunk$set(tidy.opts=list(width.cutoff=90))
```
...
```{r,eval=T,warning=F,results="hide",message=F}
memory.limit(size=10000)
...
TRIM29 | hypo-methylated in normal breast, hyper-methylated in other normal tissues, hyper-methylated 
-      | in breast cancer; hyper-methylated in breast tumor compared to breast normal 

Gene   | Expression Level
------ | ----------------
-      | Tissue Specific Methylation Paper; Minfi-Epiviz Protocol
ALX4   | expression reduced in breast cancers;  no expression in any of the four samples
ST18   | silenced in breast cancers; not expressed in the normal tissues, barely expressed in breast tumor
TP73   | down-regulated in breast cancers; no expression in any of the four samples
TRIM29 | repressed in breast cancer, colon normal, and lung normal; most expressed in normal breast tissue, 
-      | barely expressed in tumor breast tissue, and unexpressed in normal colon and normal lung tissue
...
ZC3H12D              | hypo-methylated     | high in colon normal, medium in breast tumor, none in breast and lung normal
...
ESR1                 | hypo-methylated     | none in colon and lung normal, low in breast normal, more in breast tumor

Top genes | Methylation Pattern | Expression pattern 
--------- | ------------------- | ------------------
TSHZ2     | hyper-methylated    | none in colon normal or lung normal, low in breast tumor, medium in breast normal
TRIM21    | hypo-methylated     | none in breast normal or lung normal, low in breast tumor and colon normal
C11orf40  | hypo-methylated     | no difference between four sample types
TRIM68    | hypo-methylated     | none in lung normal, low in breast tumor and colon normal, medium in breast normal
ZFPM2     | hypo-methylated     | none in colon normal, low in breast normal, high in breast tumor and lung normal
